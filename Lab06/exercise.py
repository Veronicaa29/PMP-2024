...
# le pun 1 pt ca sunt val default la o distributie gamma la care nu stiu prea multe despre ea
alpha_prior = 1     # Presupunem că rata medie a priori este 15 apeluri/oră
beta_prior = 1   # Presupunem o deviație standard de 5 apeluri/oră
...
#Functia densitate a priori (Gamma)
